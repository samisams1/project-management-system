...
class ProjectsController extends Controller
{
    ...
    public function list_view(Request $request, $type = null)
    {
        ...
        return view('projects.projects', ['projects' => $projects, 'users' => $users, 'clients' => $clients, 'toSelectProjectUsers' => $toSelectProjectUsers, 'toSelectProjectClients' => $toSelectProjectClients, 'is_favorites' => $is_favorites]);
    }
